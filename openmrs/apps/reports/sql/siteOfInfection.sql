select identifier as 'Patient Id' , PatientName as 'Patient Name' , name as 'Site of Infection' from (
...
where o.voided = 0 and o.date_activated between '#startDate#' and '#endDate#' and cn.name in ('Breast surgery','Burns surgery',
