select identifier as 'Patient ID', PatientName as 'Patient Name' , Surgery  from (
...
(select concept_id from concept_name where name = "Orthoplastic surgery" and concept_name_type = "FULLY_SPECIFIED" and voided = 0) 
